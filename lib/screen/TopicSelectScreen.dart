    ...
    return Expanded(
      child: Padding(
        ...
        child: GridView.count(
          ...
          children: const [
            _TopicCard(icon: 'assets/work.png', label: '일 / 커리어'),
            _TopicCard(icon: 'assets/talk.png', label: '관계 / 소통'),
            _TopicCard(icon: 'assets/talk.png', label: '가치 / 철학'),
            _TopicCard(icon: 'assets/idea.png', label: '상상 / 창작'),
            _TopicCard(icon: 'assets/talk.png', label: '?'),
            _TopicCard(icon: 'assets/talk.png', label: '일상 / 취향'),
          ],
        ),
      ),
    );
      ...
      children: [
        ...
        TextButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => NicknameSelectScreen()),
            );
          },
          child: const Text(
            '건너뛰기',
